<section class="bg-white py-16">
    <div class="container mx-auto flex flex-col lg:flex-row items-center px-8 lg:px-16">
        <!-- Image -->
        <aside class="lg:w-1/2 flex justify-center mb-8 lg:mb-0" data-aos="fade-right" data-aos-duration="1000"
            data-aos-easing="ease-in-out">
            <img src="{{ asset('assets/image2.png') }}" alt="Kesehatan Gigi" class="w-full h-auto max-w-lg">
        </aside>

        <!-- Description -->
        <article class="lg:w-1/2 text-center lg:text-left lg:pl-10 mt-4 lg:mt-0" data-aos="fade-left"
            ...
            <p class="text-black mb-4 text-justify">
                ...
                abaikan pentingnya kesehatan mulut, karena kesehatan gigi yang baik berkontribusi pada kualitas hidup
                yang lebih baik.
            </p>
        </article>
    </div>
